...
<form action ="{{route('articles.store')}}" method ="post">
...
</select>        <label class="form-label" for="form6Example1">Category</label>
      </div>
    </div>
    <div class="col">
      <div class="form-outline">
...
</select>        <label class="form-label" for="form6Example2">Color</label>
      </div>
    </div>
  </div>
  <!-- Text input -->
  <div class="form-outline mb-4">
    ...
    <input type="text" id="form6Example3" name="article-src" value="{{old('article-src')}}"  class="form-control" />
  ...
  <div class="form-outline mb-4">
    ...
    <input type="number" id="form6Example6" name="article-price" value="{{old('article-price')}}"  class="form-control" />
