              ...
              <div class="box">
                ...
                @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input id="name"  name="prenom" required type="text" class="form-control">
                    @error('prenom')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{$message}}</strong>
                                    </span>
                  ...
                  <div class="form-group">
                    ...
                    <input id="email"   required  name="email" type="text" class="form-control">
            ...
            <div class="col-lg-6">
              <div class="box">
                ...
                @csrf
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input id="email" type="text" name="email" value="{{ old('email') }}" required class="form-control">
                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
