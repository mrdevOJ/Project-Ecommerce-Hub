      ...
      <div id="top">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 text-center text-lg-right">    @if(auth()->user()->email=="livreur1@gmail.com" || auth()->user()->email=="livreur2@gmail.com")
             <a href="{{ route('livraisons.index') }}">vous livraisons</a>
@endif
...
@else
        ...
        <span class="sr-only">Accuile</span></a>
          ...
          <div id="navigation" class="collapse navbar-collapse">
            ...
            <div class="navbar-buttons d-flex justify-content-end">
              <!-- /.nav-collapse-->
              <div id="search-not-mobile" class="navbar-collapse collapse"></div><a data-toggle="collapse" href="#search" class="btn navbar-btn btn-primary d-none d-lg-inline-block"><span class="sr-only">search</span><i class="fa fa-search"></i></a>
  ...
  <option value="White">With</option>
              ...
              <div class="input-group-append">
                <button type="submit"   class="btn btn-primary scroll-to"><i class="fa fa-search"></i></button>
              </div>
            </div>
          </form>
